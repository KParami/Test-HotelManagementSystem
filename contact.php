                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                        <div class="item active">
                               <img src="image/hotel/h1.jpg" width="1200" height="300">     
                          </div>

                        <div class="item">
                               <img src="image/hotel/h2.jpg"  width="1200" height="300">
                                       
                          </div>
    
                        <div class="item">
                                 <img src="image/hotel/h3.jpg"  width="1200" height="300">
                         </div>

                        <div class="item">
                                  <img src="image/hotel/h4.jpg"  width="1200" height="300">    
                        </div>
                	...
                	<div class="row">
                     <div class="col-lg">
                         <div class="well well-sm">
                              <form method="POST" class="form-horizontal" action="comment.php" onsubmit="return validate();" >	
                                  <fieldset back>

...
.bg-2{
  background: url(image/wedding/w.jpg  );
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="image/fd/fd1.jpg" alt="Food & Drink" width="1200" height="300">     
      </div>

      <div class="item">
        <img src="image/fd/fd2.jpg" alt="Food & Drink" width="1200" height="300">
      ...
      <div class="item">
        <img src="image/fd/fd.jpg" alt="Food & Drink" width="1200" height="300">
        <div class="carousel-caption">
          <h3></h3>
          <p>some text</p>
        </div>      
      ...
      <div class="item">
        <img src="image/fd/fd3.jpg" alt="Food & Drink" width="1200" height="300">
        <div class="carousel-caption">
          <h3></h3>
          <p>some text</p>
        </div>      
...
<div class="container">
  ...
  <p><em> “Cada idioma es un modo distinto de ver la vida” by Federico Fellini  Translation: Every language is a different way to see the world. </em></p>
                          </div>
  <H1>OUR SPECIALS </H1> <br>
                            <div class="row text-center">
                                    <div class="col-sm-4">
                                      <div class="thumbnail">
                                      <h3>Lorem ipsum dolor</h3>
                                        <img src="image/food/food3.jpg">
...
<div class="row">
  <div class="column" style="background-color:azure;">
    <img src="image/discover/discover4.jpg" style="width:100%">
  ...
  <br><br><br><br>
    <H1>OUR STORY</H1>
    <br><br>
    <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam.<br> Sed commodo nibh ante facilisis bibendum dolor feugiat at. Duis sed dapibus leo nec ornare diam commodo nibh.

Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br> Duis sed dapibus leo nec ornare diam. Sed commodo nibh ante facilisis bibendum dolor feugiat at. Duis sed dapibus leo nec ornare.</p>
  <br>
  <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam.<br> Sed commodo nibh ante facilisis bibendum dolor feugiat at. Duis sed dapibus leo nec ornare diam commodo nibh.
...
<br><br><br><h1>MENU</h1><br><br>


<div class="row">
  <div class="column" style="background-color:white;">
    <div class="col-xs-12 col-md">
        <div class="menu-section"><br>
          <h1 class="menu-section-title">BREAKFAST & STARTERS</h1> 
 ...
 <div class="col-xs-12 col-md">
        <div class="menu-section"><br>
          <h1 class="menu-section-title">DINNER</h1> 
          <div class="menu-item"><br>
            <div class="menu-item-name">Tortellini Skewers</div>
            <div class="menu-item-price">$9</div>
            <div class="menu-item-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, duis sed dapibus leo nec ornare diam.</div>
  ...
  <div class="col-xs-12 col-md">
        <div class="menu-section"><br>
          <h1 class="menu-section-title">MAIN COURSE</h1> 
          <div class="menu-item"><br>
            <div class="menu-item-name">Tortellini Skewers</div>
            <div class="menu-item-price">$9</div>
            <div class="menu-item-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, duis sed dapibus leo nec ornare diam.</div>
          ...
          <div class="col-xs-12 col-md">
        <div class="menu-section"><br>
          <h1 class="menu-section-title">DESEART</h1> 
          <div class="menu-item"><br>
            <div class="menu-item-name">Tortellini Skewers</div>
            <div class="menu-item-price">$9</div>
            <div class="menu-item-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, duis sed dapibus leo nec ornare diam.</div>

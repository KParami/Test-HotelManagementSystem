...
.bg-1{
  background: url(image/party/bparty.jpg  );
...
.bg-2{
  background: url(image/party/party2.jpg  );
  background-position: center;
  background-repeat: no-repeat;
  background-attachment: scroll; 
  background-size:60%;
...
.bg-3{
  background: url(image/c/couple1.jpg  );
  background-position: center;
  background-repeat: no-repeat;
  background-attachment: scroll; 
  background-size:60%;
...
.bg-4{
  background: url(image/c/couple6.jpg  );
  background-position: center;
  background-repeat: no-repeat;
  background-attachment: scroll; 
  background-size:60%;
     ...
     <script>
                          ...
                          <div id="myCarousel" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                  <img src="image/party/party.jpg"  width="1200" height="300">    
                                </div>

                                <div class="item">
                                  <img src="image/party/bparty.jpg"  width="1200" height="300">     
                                </div>
                              
                                <div class="item">
                                  <img src="image/party/pool.jpg"  width="1200" height="300">    
                                </div>

                                <div class="item">
                                  <img src="image/party/pool1.jpg"  width="1200" height="300">      
                                </div>
        ...
        <div class="container">
                ...
                <p class="text-center"><em> “Cada idioma es un modo distinto de ver la vida” by Federico Fellini  Translation: Every language is a different way to see the world. </em></p>
                              ...
                              <br><br><br>
                              <h1 class="text-center">ENJJOY YOU LIFE EVERY MOMENT!!!  <br> KEEP YOUR SMILE FOREVER!! </h1>
    ...
    <div class="container">
        <div class="timeline"> <br><br><br><br>
                 <div class="container right">
                   <div class="content">
                       <em> <h2>THE MOST WONDERLDUL MOVEMENT</h2></em>
                   </div>
                 </div>
...
<div class="bg-3">
    <div class="container">
        <div class="timeline"><br><br><br><br>
                 <div class="container right">
                     <div class="content">
                        <em> <h2>HAPPY LIFE WITH MEMORIES</h2></em>
                      </div>

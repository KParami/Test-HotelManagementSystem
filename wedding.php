...
<div id="wedding" class="carousel slide" data-ride="carousel">
                                                               ...
                                                               <!-- Wrapper for slides -->
                                                                  <div class="carousel-inner" role="listbox">
                                                                       <div class="item active">
                                                                          <img src="image/wedding/wedding2.jpg" alt="WEDDING" width="1200" height="300">
                                                                            <div class="carousel-caption">
                                                                                   <h3> </h3>
                                                                                   <p> DECIDE YOUR WEDDING DREAM</p>
                                                                            </div>      
                                                                        </div>
                                                                       <div class="item">
                                                                          <img src="image/wedding/wedding1.jpg" alt="WEDDING" width="1200" height="300">
                                                                          <div class="carousel-caption">
                                                                                    <h3></h3>
                                                                                    <p> LET THEM TO SUCCESS YOUR DREAM</p>
                                                                           </div>      
                                                                         </div>
                                                                       ...
                                                                       <div class="item">
                                                                          <img src="image/wedding/wedding2.jpg" alt="WEDDING" width="1200" height="300">
                                                                           <div class="carousel-caption">
                                                                                     <h3></h3>
                                                                                    <p> FIND YUR DREAM WEDDING</p>
                                                                          </div>      
                                                                       </div>

                                                                       <div class="item">
                                                                          <img src="image/wedding/wed1.jpg" alt="Chicago" width="1200" height="300">
                                                                            <div class="carousel-caption">
                                                                                      <h3></h3>
                                                                                     <p>A DAY YOU NEVER FORGET TTHAT</p>
                                                                           </div>      
                                                                       </div>
 ...
 <br>
               ...
               <p class="text-center"><em> “Cada idioma es un modo distinto de ver la vida” by Federico Fellini Translation: Every language is a different way to see the world. </em></p> <br>                        
                <h2> ACHIEVE YOUR DREAM WEDDING</h2> <br><br><br><br><br><br>

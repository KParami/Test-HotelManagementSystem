                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                        <div class="item active">
                               <img src="image/hotel/h1.jpg" alt="La Bonne Nuit" width="1200" height="300">
                        ...
                        <div class="item">
                               <img src="image/hotel/h2.jpg" alt="La Bonne Nuit" width="1200" height="300">
                                 <div class="carousel-caption">
                                      <h3></h3>
                                      <p> some text</p>
                                 </div>      
                        ...
                        <div class="item">
                                 <img src="image/hotel/h3.jpg" alt="Los Angeles" width="1200" height="300">
                                   <div class="carousel-caption">
                                      <h3></h3>
                                      <p> some text</p>
                                  </div>      
                        ...
                        <div class="item">
                                  <img src="image/hotel/h4.jpg" alt="Chicago" width="1200" height="300">
                                     <div class="carousel-caption">
                                       <h3></h3>
                                       <p></p>
                                   </div>      
...
<aside>
 <br>
 <em> <p>
  Dear Guests, Dear Friends, </p><br>
           <p>The Hotel La' PERLA is open and, as always, our teams are on hand to respond to your inquiries. </p>
            <p>During your stay, you may take full advantage of our delicious room service menu as well as access
               to the pool by reservation and in keeping with current health guidelines.</p>
             <p>Gift cards are also available at the hotel or online,so you can surprise and delight loved ones by offering them a
                unique moment at the La' PERLA. </p>
            <p>The Tasaki and TWG boutiques in our shopping gallery are open and pleased to welcome guests. </p>
           <p> We look forward to welcoming you once again to our bars and restaurants as soon as 
            health and safety regulations permit.</p><br><br>

            

            <p>Most of all, we thank you for your confidence.</p><br>

            

            <p>Take good care,</p><br>

            <p>The teams at the LA' PERLA.</p></em>
                                                                      </aside>
 </div>
